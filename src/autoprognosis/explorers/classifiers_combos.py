...
class EnsembleSeeker:
    ...
    def __init__(
        ...
        # ============================================================
        # [關鍵修改] 將預設值 "bayesian" 改為 "hyperband"
        # ============================================================
        optimizer_type: str = "hyperband",  # <--- 這裡改掉了！
        random_state: int = 0,
    ) -> None:
        ...
        # 這裡會將 "hyperband" 字串傳遞給底層的 ClassifierSeeker
        self.seeker = ClassifierSeeker(
            ...
            hooks=hooks,
            imputers=imputers,
            optimizer_type=optimizer_type, # 這裡會傳入 "hyperband"
    ...
    def search_weights(
        ...
        study = EnsembleOptimizer(
            ...
            optimizer_type=self.optimizer_type, # 這裡也會使用 "hyperband"
